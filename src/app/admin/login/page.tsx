      ...
      <div className="w-full max-w-[440px] relative z-10">
        ...
        <div className="text-center mb-10">
          <Image
            ...
            unoptimized
          />
          <p className="text-[0.7rem] font-bold uppercase tracking-[0.25em] text-slate-500 mt-4">
            Admin Dashboard
          </p>
        </div>
        ...
        <div className="bg-white/[0.04] backdrop-blur-xl border border-white/10 rounded-3xl p-8 sm:p-10 shadow-2xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-white/5 border border-white/10 rounded-xl pl-12 pr-4 py-3.5 text-sm text-white placeholder-slate-500 focus:outline-none focus:border-[#ff5e14]/50 focus:ring-2 focus:ring-[#ff5e14]/20 transition-all"
                  required
                  autoFocus
                />
              </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-white/5 border border-white/10 rounded-xl pl-12 pr-12 py-3.5 text-sm text-white placeholder-slate-500 focus:outline-none focus:border-[#ff5e14]/50 focus:ring-2 focus:ring-[#ff5e14]/20 transition-all"
                  required
                />
                <button
                  type="button"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-gradient-to-r from-[#ff5e14] to-[#e05010] hover:from-[#e05010] hover:to-[#cc4400] text-white font-bold text-sm rounded-xl py-4 shadow-lg shadow-orange-500/20 hover:shadow-orange-500/30 transition-all duration-300 disabled:opacity-60 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
              {loading ? (
                <>
        ...
        <p className="text-center text-slate-600 text-xs mt-8">
          © {new Date().getFullYear()} Tom Sutton Heating — Admin Panel
        </p>
      </div>
    </div>
  );
