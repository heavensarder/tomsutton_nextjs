...
export default function AlphaETecPlusPage() {
  return (
    <main className="min-h-screen bg-slate-50">
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-16">
            ...
            <div className="w-full lg:w-[55%] flex flex-col items-center lg:items-start text-center lg:text-left text-white">
              ...
              <div className="space-y-2 text-[0.95rem] sm:text-[1.05rem] font-medium leading-[1.6] text-white/90 overflow-hidden mb-10 max-w-[600px]">
                <p>Get a new Alpha E-Tec Plus Combi boiler expertly installed by our dedicated local team. We offer fast, friendly and highly reliable service ensuring your home stays comfortably warm throughout the year.</p>
              </div>
            ...
            <div className="w-full lg:w-[40%] relative mt-8 lg:mt-0 group z-20 flex justify-center lg:justify-end">
              <div className="relative w-full max-w-[300px] sm:max-w-[350px] aspect-[3/4] rounded-3xl overflow-hidden shadow-2xl ring-4 ring-white/10 transform transition-transform duration-700 group-hover:-translate-y-2 bg-gradient-to-br from-slate-800/60 to-slate-900/90 backdrop-blur-md p-8">
                <Image 
                  src="https://i.postimg.cc/htbrTR0Q/ETEC-PLUSsm-200x300.webp" 
                  alt="Alpha E-Tec Plus Boiler" 
                  fill 
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-start">
            ...
            <div className="lg:col-span-4 flex flex-col items-center lg:sticky lg:top-32">
              <div className="relative w-[70%] sm:w-[50%] lg:w-[90%] max-w-[320px] aspect-[4/5] mb-8 group">
                <Image 
                  src="https://i.postimg.cc/T1qFm0vH/ETEC_PLUS_300x300.webp" 
                  alt="Alpha E-Tec Plus Hardware Overview" 
                  fill 
            ...
            <div className="lg:col-span-8 flex flex-col">
              ...
              <div className="mb-8 space-y-3 text-slate-600 font-medium text-[0.95rem] lg:text-[1.05rem] leading-[1.7] text-balance">
                <p>
                  Alpha's popular E-Tec range has evolved with the addition of the E-Tec Plus combi. The compact boilers features a stainless steel heat exchanger and now comes with a 10 year warranty as standard, straight out the box.
                </p>
                <p>
                  Available in three outputs, 28, 33 and 38kW, making it a great choice for small to medium homes with up to two bathrooms.
                </p>
              </div>
      ...
      <section className="py-16 sm:py-24 bg-slate-50 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <FaqAccordion items={[
            {
              question: "What is the Alpha E-Tec Plus?",
              answer: "The Alpha E-Tec Plus is a popular compact combi boiler featuring a stainless steel heat exchanger and 10-year warranty as standard. Available in 28, 33, and 38kW outputs, it offers reliable performance for small to medium-sized homes."
            },
            {
              question: "What warranty comes with the E-Tec Plus?",
              answer: "The Alpha E-Tec Plus comes with a 10-year warranty as standard, straight out of the box. This is one of the most generous standard warranties available and reflects the quality and reliability of the product."
            },
            {
              question: "What output should I choose — 28, 33, or 38kW?",
              answer: "The 28kW model suits smaller homes with one bathroom. The 33kW is ideal for medium homes with up to two bathrooms. The 38kW model is designed for larger homes with higher hot water demand. We will recommend the right size during your free survey."
            },
            {
              question: "What are the key features of the E-Tec Plus?",
              answer: "Key features include a stainless steel heat exchanger, high-efficiency Grundfos pump, single electrode ignition, easy-access dry-change NTCs, combined condensate and pressure relief valve connection, zinc plated expansion vessel, and an integrated filling loop."
            }
          ]} />
        </div>
      </section>
