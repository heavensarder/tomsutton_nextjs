...
export default function AlphaEvokePage() {
  return (
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-16">
            ...
            <div className="w-full lg:w-[55%] flex flex-col items-center lg:items-start text-center lg:text-left text-white">
              ...
              <div className="space-y-2 text-[0.95rem] sm:text-[1.05rem] font-medium leading-[1.6] text-white/90 overflow-hidden mb-10 max-w-[600px]">
                <p>Get a new Alpha Evoke combi boiler expertly installed by our dedicated local team. We offer fast, friendly and highly reliable service ensuring your home stays comfortably warm throughout the year.</p>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-start">
            ...
            <div className="lg:col-span-4 flex flex-col items-center lg:sticky lg:top-32">
              <div className="relative w-[70%] sm:w-[50%] lg:w-[90%] max-w-[320px] aspect-[4/5] mb-8 group">
                <Image 
                  src="https://i.postimg.cc/0jdFmn1X/EVOKE_2_300x300.webp" 
                  alt="Alpha Evoke Hardware Overview" 
                  fill 
            ...
            <div className="lg:col-span-8 flex flex-col">
              ...
              <div className="mb-8 space-y-3 text-slate-600 font-medium text-[0.95rem] lg:text-[1.05rem] leading-[1.7] text-balance">
                <p>
                  The newest addition to Alpha's combi boilers, the Evoke range features a brand new stainless steel heat exchanger and is our smallest yet. Being compact allows an easy fit in a standard kitchen cupboard and servicing is made easy with front access.
                </p>
                <p>
    ...
    {/* FAQs Section */}
      <section className="py-16 sm:py-24 bg-slate-50 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <FaqAccordion items={[
            {
              question: "What is the Alpha Evoke boiler?",
              answer: "The Alpha Evoke is the premium model in Alpha’s range, featuring a stainless steel heat exchanger, high-efficiency Grundfos pump, and advanced controls. It is designed for reliability and performance, offering a great combination of quality and value."
            },
            {
              question: "What warranty does the Alpha Evoke come with?",
              answer: "The Alpha Evoke comes with a generous warranty straight out of the box, giving you peace of mind that your investment is fully protected. We handle the complete warranty registration process as part of our installation service."
            },
            {
              question: "Is the Alpha Evoke energy efficient?",
              answer: "Yes, the Alpha Evoke is an A-rated condensing boiler that achieves over 90% efficiency. This means it converts more of the gas you pay for into useful heat, keeping your energy bills as low as possible."
            },
            {
              question: "What outputs is the Evoke available in?",
              answer: "The Alpha Evoke is available in a range of outputs to suit different property sizes and hot water demands. During your free survey, we will recommend the right output based on your home’s specific requirements."
            }
          ]} />
        </div>
      </section>
