          ...
          <div className="flex flex-col md:flex-row gap-16 lg:gap-20">
            ...
            <div className="w-full md:w-[50%] flex flex-col items-center md:items-start text-center md:text-left">
              ...
              <div className="space-y-6 text-gray-500 font-medium text-[0.95rem] sm:text-[1rem] leading-[1.8] mb-10 w-full text-left">
                ...
                <p>
                  To speak with us regarding gas services, please call <strong className="text-slate-800 font-bold">01590 540188</strong> or <strong className="text-slate-800 font-bold">07774 673109</strong> or leave your details on our contact form and we’ll get back to you as soon as possible.
                </p>
                <p>
