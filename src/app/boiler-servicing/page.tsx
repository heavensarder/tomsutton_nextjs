...
export default function BoilerServicingPage() {
  return (
    <main className="min-h-screen bg-white">
      ...
      {/* Custom Floating Banner Hero Section */}
      <section className="relative w-full min-h-[380px] h-[55vh] max-h-[450px] lg:max-h-[600px] lg:h-[65vh] flex items-center overflow-hidden z-10 bg-[#f8fafd]">
        ...
        <div className="absolute inset-0 z-0">
          <Image 
            src="https://i.postimg.cc/bNrQ8QhJ/hero-background.webp" 
            alt="Boiler Servicing and Annual Maintenance" 
            fill
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full flex items-center justify-center lg:justify-end lg:pr-[15%]">
          ...
          <div className="flex flex-col items-center lg:items-end max-w-[95%] sm:max-w-[700px] w-full transform scale-[0.85] sm:scale-100 origin-center lg:origin-right">
            ...
            <div className="bg-gradient-to-r from-[#4da6cd] to-[#2968b5] w-[100%] px-4 sm:px-12 py-5 sm:py-8 text-center flex items-center justify-center">
            ...
            <div className="bg-gradient-to-r from-[#e0805c] to-[#cd322e] w-[92%] sm:w-[88%] px-4 sm:px-10 py-3 sm:py-4 text-center flex items-center justify-center">
              <h2 className="text-[0.8rem] sm:text-[1.05rem] lg:text-[1.15rem] text-white font-medium tracking-[0.05em] uppercase m-0 leading-none drop-shadow-[0_1px_2px_rgba(0,0,0,0.4)]">
      ...
      {/* Enhanced Annual Boiler Service Information Section */}
      <section className="relative bg-[#f8fafd] py-20 lg:py-32 overflow-hidden border-t border-slate-100">
        ...
        <div className="absolute bottom-0 left-1/4 w-80 h-80 bg-cyan-400/5 rounded-full blur-[100px] pointer-events-none"></div>

        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-[1000px] relative z-10 text-center">
          
          {/* Decorative Badge */}
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white border border-blue-100 shadow-[0_4px_20px_-5px_rgba(59,130,246,0.15)] mb-8">
            <span className="w-2 h-2 rounded-full bg-blue-500 animate-pulse"></span>
            <span className="text-xs sm:text-sm font-bold tracking-widest text-slate-600 uppercase">Expert Maintenance</span>
          </div>

          <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-[#0d1033] mb-8 tracking-tight">
            Annual <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-cyan-500">Boiler Service</span>
          </h2>
          
          <div className="space-y-10 max-w-[850px] mx-auto">
            {/* Primary Text */}
            <p className="text-slate-600 text-[1.05rem] sm:text-[1.15rem] leading-[1.8] font-medium px-4">
              We are committed to keeping you warm throughout the winter, this is why we offer flexible boiler service options. Our basic boiler service starts at <strong className="text-slate-800 font-bold">£80</strong>, and our standard boiler service costs just <strong className="text-slate-800 font-bold">£90</strong>. We also offer superb <Link href="/boiler-care-plans" className="font-bold text-blue-600 hover:text-blue-700 underline underline-offset-4 decoration-blue-200 transition-colors">care plans</Link> for those customers who may want to spread the costs associated with boiler maintenance and want to take advantage of the extra benefits of being a monthly subscriber to one of our <Link href="/boiler-care-plans" className="font-bold text-blue-600 hover:text-blue-700 underline underline-offset-4 decoration-blue-200 transition-colors">care plans</Link>.
            </p>

            {/* Elevated Recommendation Card */}
            <div className="relative bg-white rounded-3xl p-8 sm:p-10 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.05)] border border-slate-100 text-left flex flex-col sm:flex-row gap-6 items-start group hover:-translate-y-1 transition-transform duration-500">
              <div className="w-14 h-14 shrink-0 bg-blue-50 rounded-2xl flex items-center justify-center border border-blue-100 group-hover:bg-blue-600 transition-colors duration-500">
              ...
              <div>
                <h3 className="text-lg font-bold text-slate-800 mb-3">Our Recommendation</h3>
                <p className="text-slate-500 text-[0.95rem] sm:text-base leading-relaxed font-medium">
                  We recommend that you have a <strong className="text-slate-700">basic boiler service</strong> in year one, followed by a <strong className="text-slate-700">standard boiler service</strong> in year two, then finally a <strong className="text-slate-700">premium boiler service</strong> in year three. This is the best method of boiler servicing to help prevent costly breakdowns and ensure optimum boiler efficiency.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="bg-[#f0f4f8] py-20 lg:py-28 border-t border-slate-200">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-[1250px]">
          <h2 className="text-center text-[2rem] sm:text-4xl md:text-[2.75rem] font-bold text-[#354359] mb-16 tracking-tight">
            Our Service Options
          </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-stretch">
            ...
            <div className="bg-gradient-to-br from-[#e08b5e] to-[#cc6035] rounded-xl p-8 sm:p-10 text-white shadow-xl flex flex-col transform transition duration-500 hover:-translate-y-2 hover:shadow-2xl">
              <h3 className="text-[1.6rem] font-bold text-center mb-6 leading-none">Premium Boiler Service</h3>
              <div className="w-[80%] mx-auto h-[1px] bg-white/30 mb-8"></div>
              <p className="text-[0.95rem] leading-relaxed text-center mb-10 min-h-[90px] text-white/95">
                Recommended to be carried out every three years minimum or every year if you want to prolong the life and efficiency of your boiler.
              </p>
              
              <ul className="space-y-4 mb-10 flex-grow text-[0.95rem] text-white/95">
                {[
                  "Visual inspection of the appliance & flue",
                  "Testing of the appliance for correct operation",
                  "Flue integrity test & combustion analysis",
                  "Drain down of the boiler, expansion vessel checked and recharged as necessary",
                  "Water quality and inhibitor levels checked",
                  "Magnetic filter serviced",
                  "Strip down and cleaning of the appliance, burner, combustion chamber and electrodes",
                  "Cleaning of the condensate trap",
                  "Service certificate issued"
                ].map((feature, i) => (
                  <li key={i} className="flex items-start gap-3">
                    <svg className="w-5 h-5 shrink-0 mt-0.5 fill-white" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" /></svg>
                    <span className="leading-snug">{feature}</span>
                  </li>
                ))}
              </ul>
              
              <div className="w-[80%] mx-auto h-[1px] bg-white/30 mb-8 mt-auto"></div>
              <div className="text-center mb-10 text-white leading-none">
                <span className="text-[2.2rem] font-bold">£110</span>
                <span className="text-[1.2rem] font-medium ml-2">inc. VAT</span>
              </div>
              <a href="https://book.servicem8.com/request_service_online_booking?strVendorUUID=b00bca15-4f6a-44c6-8974-1b55a86bb7cb#4d327f8b-d007-4c92-96b1-1ba28d376aab" target="_blank" rel="noopener noreferrer" className="block w-full text-center border-2 border-white/80 py-3.5 rounded-sm font-bold text-sm tracking-wider hover:bg-white hover:text-[#ce6237] transition-all">
                BOOK NOW
              </a>
            </div>

            {/* Standard Boiler Service */}
            <div className="bg-gradient-to-br from-[#4db198] to-[#3a8b75] rounded-xl p-8 sm:p-10 text-white shadow-xl flex flex-col transform scale-100 lg:scale-105 z-10 transition duration-500 hover:-translate-y-2 hover:shadow-2xl">
              <h3 className="text-[1.6rem] font-bold text-center mb-6 leading-none">Standard Boiler Service</h3>
              <div className="w-[80%] mx-auto h-[1px] bg-white/30 mb-8"></div>
              <p className="text-[0.95rem] leading-relaxed text-center mb-10 min-h-[90px] text-white/95">
                Our most popular boiler service level. This is an intermediate service level that can often be used if you do not find a premium service necessary every year.
              </p>
              ...
              <ul className="space-y-4 mb-10 flex-grow text-[0.95rem] text-white/95">
                {[
                  ...
                  "Testing of the appliance for correct operation",
                  "Flue integrity test & combustion analysis",
                  "Magnetic filter serviced included",
                  "Strip down and cleaning of the appliance, burner, combustion chamber and electrodes",
                  "Cleaning of the condensate trap",
                  "Service certificate issued"
                ].map((feature, i) => (
              ...
              <div className="w-[80%] mx-auto h-[1px] bg-white/30 mb-8 mt-auto"></div>
              <div className="text-center mb-10 text-white leading-none">
                <span className="text-[2.2rem] font-bold">£95</span>
                <span className="text-[1.2rem] font-medium ml-2">inc. VAT</span>
              </div>
              <a href="https://book.servicem8.com/request_service_online_booking?strVendorUUID=b00bca15-4f6a-44c6-8974-1b55a86bb7cb#f841f607-4525-48ca-9352-1ce718b6c42b" target="_blank" rel="noopener noreferrer" className="block w-full text-center border-2 border-white/80 py-3.5 rounded-sm font-bold text-sm tracking-wider hover:bg-white hover:text-[#3b8c76] transition-all">
                BOOK NOW
              </a>
            </div>

            {/* Basic Boiler Service */}
            <div className="bg-gradient-to-br from-[#50a4c8] to-[#2b68b3] rounded-xl p-8 sm:p-10 text-white shadow-xl flex flex-col transform transition duration-500 hover:-translate-y-2 hover:shadow-2xl">
              <h3 className="text-[1.6rem] font-bold text-center mb-6 leading-none">Basic Boiler Service</h3>
              <div className="w-[80%] mx-auto h-[1px] bg-white/30 mb-8"></div>
              <p className="text-[0.95rem] leading-relaxed text-center mb-10 min-h-[90px] text-white/95">
                This is an entry-level service. It is not recommended to carry out this level of service on any boilers over three years old unless you have had a basic or premium service the previous year.
              </p>
              ...
              <div className="w-[80%] mx-auto h-[1px] bg-white/30 mb-8 mt-auto"></div>
              <div className="text-center mb-10 text-white leading-none">
                <span className="text-[2.2rem] font-bold">£85</span>
                <span className="text-[1.2rem] font-medium ml-2">inc. VAT</span>
              </div>
              <a href="https://book.servicem8.com/request_service_online_booking?strVendorUUID=b00bca15-4f6a-44c6-8974-1b55a86bb7cb#11b22cff-fdf7-42cb-aa8c-1ba2896662fb" target="_blank" rel="noopener noreferrer" className="block w-full text-center border-2 border-white/80 py-3.5 rounded-sm font-bold text-sm tracking-wider hover:bg-white hover:text-[#2b68b3] transition-all">
                BOOK NOW
              </a>
            </div>
      ...
      {/* Landlord Gas Safety Certificates Section */}
      <section className="bg-white py-20 lg:py-28 border-t border-slate-100">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-[950px] text-center">
          
          {/* Decorative Compliance Badge */}
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-slate-50 border border-slate-200 mb-6 shadow-[0_2px_10px_-4px_rgba(0,0,0,0.05)] hover:shadow-md transition-shadow">
            ...
            <span className="text-xs sm:text-sm font-bold tracking-widest text-slate-700 uppercase">Legal Compliance</span>
          </div>

          <h2 className="text-[1.8rem] sm:text-[2.25rem] md:text-[2.75rem] font-black text-[#0d1033] mb-10 tracking-tight leading-tight">
            Landlord Gas Safety <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#df5443] to-[#b33628]">Certificates</span>
          </h2>
          
          {/* Formatted Text Box */}
          <div className="bg-[#f8fafd] rounded-3xl p-8 sm:p-12 border border-slate-200 shadow-[0_10px_40px_-10px_rgba(0,0,0,0.04)] mx-auto text-left relative overflow-hidden group">
            {/* Soft decorative background element */}
            <div className="absolute top-0 right-0 w-32 h-32 bg-[#df5443]/5 rounded-bl-[100px] pointer-events-none group-hover:bg-[#df5443]/10 transition-colors duration-500"></div>

            <p className="text-[#475569] text-[1.05rem] sm:text-[1.15rem] leading-[1.8] font-medium relative z-10">
              If you are landlord, I am sure you already know that you are legally required to have a landlord gas safety inspection carried out on your property every year. Or before a change of tenancy. Tom Sutton Heating is here to help, offering Landlords Gas Safety certificates from just <strong className="text-slate-800 font-bold whitespace-nowrap">£70</strong> or a landlords gas safety certificate and boiler service from just <strong className="text-slate-800 font-bold whitespace-nowrap">£120</strong>. We also offer the same maintenance plans to landlords, where you will find that you will get your gas safety certificate comes at <strong className="text-slate-800 font-bold text-[#df5443]">no extra charge</strong> with your subscription.
            </p>
          </div>
      ...
      {/* Premium Boiler Care Plans Deep Gradient Banner */}
      <section className="relative w-full bg-gradient-to-r from-[#1e40af] via-[#2563eb] to-[#0ea5e9] py-20 sm:py-24 text-center text-white px-4 border-t border-b border-blue-400/20 overflow-hidden shadow-inner">
        {/* Soft decorative light flares */}
        <div className="absolute top-1/2 left-0 w-full h-[1px] bg-gradient-to-r from-transparent via-white/20 to-transparent shadow-[0_0_15px_rgba(255,255,255,0.5)]"></div>
        <div className="absolute top-0 right-10 w-64 h-64 bg-cyan-400/10 rounded-full blur-[80px] pointer-events-none"></div>

        <div className="relative z-10 container mx-auto">
          <h2 className="text-[2.5rem] sm:text-5xl lg:text-[3.5rem] font-black mb-6 tracking-tight drop-shadow-[0_4px_4px_rgba(0,0,0,0.15)] leading-tight">Boiler Care Plans</h2>
          <p className="text-[1.05rem] sm:text-[1.25rem] font-bold tracking-[0.2em] uppercase text-blue-50 drop-shadow-sm">SPREAD THE COST FOR PEACE OF MIND</p>
        </div>
      </section>

      {/* Modern Split-Grid Information & Logo Slider Component */}
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-[1250px]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center mb-28">
            ...
            <div className="lg:col-span-5 flex flex-col items-center lg:items-start text-center lg:text-left">
              ...
              <h3 className="text-[2.25rem] sm:text-[3rem] md:text-[3.5rem] font-black text-[#0d1033] tracking-tight leading-[1.1] mb-8">
                Highest Level of <br className="hidden lg:block" />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-700 to-cyan-500">Quality.</span>
              </h3>
              <p className="text-slate-600 text-lg sm:text-[1.2rem] font-medium leading-relaxed max-w-[600px] mx-auto lg:mx-0">
                Choosing the right company to service your boiler is important. We believe that a company offering comprehensive boiler servicing options will give you the best service for your money.
              </p>
            </div>
              ...
              <div className="bg-white rounded-[2rem] p-8 sm:p-10 shadow-[0_10px_40px_-10px_rgba(0,0,0,0.06)] border border-slate-100 flex flex-col sm:flex-row gap-6 sm:items-start group hover:-translate-y-1 transition-transform duration-500">
                ...
                <div className="text-center sm:text-left">
                  ...
                  <div className="bg-[#f8fafd] p-6 rounded-2xl border border-slate-200 shadow-sm relative overflow-hidden group/box">
                    ...
                    <Link href="/boiler-maintenance-plans" className="inline-flex items-center gap-2 text-blue-600 font-bold hover:text-blue-800 transition-colors group/link text-[0.95rem]">
          ...
          <div className="relative w-full max-w-[1100px] mx-auto overflow-hidden [mask-image:_linear-gradient(to_right,transparent_0,_black_128px,_black_calc(100%-128px),transparent_100%)] mt-10">
            <div className="flex w-max animate-slider hover:[animation-play-state:paused] items-center">
              {/* Combine the 4 exact requested logos replicated 4 times to fill the ultra-wide scroll width securely */}
              {[
      ...
      <section className="bg-white py-20 lg:py-32 border-t border-slate-100 relative overflow-hidden">
