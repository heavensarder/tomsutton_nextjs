...
export const metadata = {
  title: 'Heating & Plumbing Services in Bournemouth | Tom Sutton Heating',
  description: 'Trusted for over 30 years. From boiler emergency repairs to renewable energy installations, reliable local service across Bournemouth and the New Forest.',
};

export default function BournemouthAreaPage() {
  return (
    <main className="w-full bg-slate-50">
      ...
      */}
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-8">
            ...
            <div className="w-full lg:w-[55%] flex flex-col items-center lg:items-start text-center lg:text-left z-20 animate-fade-in-up">
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl xl:text-[4rem] font-black text-white tracking-tight leading-[1.1] mb-6">
                Expert Heating &<br className="hidden sm:block" /> Plumbing Services<br className="hidden lg:block"/> in <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-[#ff5e14]">Bournemouth</span>
              </h1>

              {/* Sub-headline */}
              <p className="text-lg sm:text-xl text-slate-300 font-medium leading-relaxed max-w-2xl mb-10">
                From boiler emergency repairs to renewable energy installations, the team at Tom Sutton Heating provides reliable, local service across Bournemouth and the New Forest.
              </p>
            ...
            <div className="w-full lg:w-[45%] relative mt-10 lg:mt-0 flex justify-center z-20">
              ...
              <div className="relative w-full max-w-[450px] lg:max-w-full h-[350px] lg:h-[400px] rounded-[2rem] overflow-hidden shadow-2xl border border-white/10 group transform hover:-translate-y-2 transition-transform duration-700">
                ...
                <Image 
                  src="https://i.postimg.cc/mgLTByf6/bournemouth.jpg" 
                  alt="Professional Boiler Installation Bournemouth" 
                  fill 
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-[1300px]">
          ...
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-10 mb-8 lg:mb-12">
            ...
            <div className="w-full lg:w-[60%] relative h-[350px] lg:h-[420px] rounded-[2rem] overflow-hidden shadow-2xl group border border-slate-200">
              ...
              <div className="absolute bottom-0 left-0 right-0 bg-slate-900/60 backdrop-blur-xl p-5 sm:p-6 border-t border-white/10 flex items-center justify-between">
                <div>
                  <p className="text-white font-bold text-lg leading-none">Local to Bournemouth</p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-5">
            ...
            <div className="bg-white p-6 rounded-[1.5rem] shadow-[0_4px_20px_rgb(0,0,0,0.03)] border border-slate-100 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 relative overflow-hidden group">
              ...
              <p className="text-slate-500 text-[13px] leading-relaxed relative z-10">Proudly serving the New Forest and Bournemouth for three continuous decades.</p>
            </div>
      ...
      <OurServices 
        title={<>Services Offered in <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#ff5e14] to-orange-500">Bournemouth</span></>} 
        subtitle="Bournemouth Services" 
      />
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-[1200px]">
          <div className="bg-white rounded-[2rem] p-8 md:p-10 shadow-sm border border-slate-200 flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="w-full md:w-1/3">
              ...
              <h2 className="text-2xl font-black text-[#0f172a] mb-2 leading-tight">Areas We Cover Near Bournemouth</h2>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-[2.8rem] font-black text-[#0d1033] tracking-tight mb-4">
              Visit Us or Get in Touch in <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#ff5e14] to-[#ff8c42]">Bournemouth</span>
            </h2>
      ...
      <section className="py-20 sm:py-28 bg-[#eef1fa] relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <FaqAccordion items={[
            {
              question: 'Do you cover all areas inside Bournemouth?',
            ...
            },
            {
              ...
              answer: 'Because we are locally based in New Milton, our engineers can offer extremely rapid response times across Bournemouth for emergency boiler repairs.'
            },
            {
              question: 'Are your engineers Gas Safe registered in the local area?',
              answer: 'Absolutely. All our local Bournemouth engineers are fully Gas Safe registered, OFTEC certified, and insured to work on both residential and commercial heating systems.'
            },
            {
              question: 'Do you offer free quotes for boiler installations in Bournemouth?',
              answer: 'Yes! We provide 100% free, no-obligation home surveys and quotes across the entire Bournemouth and Dorset area so we can accurately assess what boiler your home needs.'
            }
          ]} />
        </div>
      </section>
