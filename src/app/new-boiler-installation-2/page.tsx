          ...
          <div className="flex flex-col lg:flex-row justify-between gap-12 lg:gap-16">
            ...
            <div className="w-full lg:w-1/2 flex flex-col items-center text-center space-y-6">
              ...
              <p className="text-base text-slate-600 max-w-lg">
                If you are looking for a new boiler installation in the Bournemouth area call us today on <a href="tel:01590631671" className="font-bold text-slate-800 hover:text-blue-600 transition-colors inline-block">01590 631671</a>.
              </p>
