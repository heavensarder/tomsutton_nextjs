...
export default function WorcesterBosch4000Page() {
  return (
    <main className="min-h-screen bg-slate-50">
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-16">
            ...
            <div className="w-full lg:w-[55%] flex flex-col items-center lg:items-start text-center lg:text-left text-white">
              ...
              <h1 className="text-[1.75rem] sm:text-3xl lg:text-[2.75rem] font-black tracking-tight leading-[1.1] mb-5 drop-shadow-md">
                WORCESTER BOSCH 4000 COMBI INSTALLATION
              </h1>
              ...
              <div className="space-y-2 text-[0.95rem] sm:text-[1.05rem] font-medium leading-[1.6] text-white/90 overflow-hidden mb-10 max-w-[600px]">
                <p>Get a new Worcester Bosch 4000 combi boiler expertly installed by our dedicated local team. We offer fast, friendly and highly reliable service ensuring your home stays comfortably warm throughout the year.</p>
              </div>
            ...
            <div className="w-full lg:w-[40%] relative mt-8 lg:mt-0 group z-20 flex justify-center lg:justify-end">
              <div className="relative w-full max-w-[300px] sm:max-w-[350px] aspect-[3/4] rounded-3xl overflow-hidden shadow-2xl ring-4 ring-white/10 transform transition-transform duration-700 group-hover:-translate-y-2 bg-gradient-to-br from-slate-800/60 to-slate-900/90 backdrop-blur-md p-8">
                <Image 
                  ...
                  alt="Worcester Bosch 4000 Combi Boiler" 
                  fill 
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-start">
            ...
            <div className="lg:col-span-4 flex flex-col items-center lg:sticky lg:top-32">
              <div className="relative w-[70%] sm:w-[50%] lg:w-[90%] max-w-[320px] aspect-[4/5] mb-8 group">
                <Image 
                  src="https://i.postimg.cc/T1bkskZs/EVOKE-5-300x300.webp" 
                  alt="Worcester Bosch 4000 Hardware Overview" 
                  fill 
            ...
            <div className="lg:col-span-8 flex flex-col">
              ...
              <div className="mb-8 space-y-4 text-slate-600 font-medium text-[0.95rem] lg:text-[1.05rem] leading-[1.7] text-balance">
                ...
                <p>
                  Worcester Bosch's entire gas boiler range is able to run on a 20% hydrogen blend - so you can be confident it will run on gas for its lifetime.
                </p>
              </div>
      ...
      <section className="py-16 sm:py-24 bg-slate-50 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <FaqAccordion items={[
            {
              question: "What is the Worcester Bosch Greenstar 4000 Combi?",
              answer: "The Greenstar 4000 is a compact, high-efficiency combi boiler designed for small to medium-sized homes. It provides both central heating and instant hot water without the need for a separate cylinder, making it ideal for properties with limited space."
            },
            {
              question: "What outputs is the Greenstar 4000 available in?",
              answer: "The Greenstar 4000 Combi is available in 25kW and 30kW output options. The 25kW model suits smaller homes with one bathroom, while the 30kW model is suitable for medium-sized homes with up to two bathrooms."
            },
            {
              question: "What warranty comes with the Greenstar 4000?",
              answer: "As Worcester Bosch Accredited Installers, we can offer up to a 13-year warranty on the Greenstar 4000 at no additional cost. This is the longest warranty available on any boiler in the UK market."
            },
            {
              question: "Is the Greenstar 4000 easy to use?",
              answer: "Yes, the Greenstar 4000 features a clear, intuitive digital display with simple controls for adjusting heating and hot water temperatures. It is also compatible with the Worcester Bosch Wave smart thermostat for remote control via your smartphone."
            }
          ]} />
        </div>
      </section>
