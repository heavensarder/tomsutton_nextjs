...
export default function WorcesterBosch4000SystemPage() {
  return (
    <main className="min-h-screen bg-slate-50">
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-16">
            ...
            <div className="w-full lg:w-[55%] flex flex-col items-center lg:items-start text-center lg:text-left text-white">
              ...
              <h1 className="text-[1.75rem] sm:text-3xl lg:text-[2.75rem] font-black tracking-tight leading-[1.1] mb-5 drop-shadow-md">
                WORCESTER BOSCH 4000 SYSTEM INSTALLATION
              </h1>
              ...
              <div className="space-y-2 text-[0.95rem] sm:text-[1.05rem] font-medium leading-[1.6] text-white/90 overflow-hidden mb-10 max-w-[600px]">
                <p>Get a new Worcester Bosch 4000 System boiler expertly installed by our dedicated local team. We offer fast, friendly and highly reliable service ensuring your home stays comfortably warm throughout the year.</p>
              </div>
            ...
            <div className="w-full lg:w-[40%] relative mt-8 lg:mt-0 group z-20 flex justify-center lg:justify-end">
              <div className="relative w-full max-w-[300px] sm:max-w-[350px] aspect-[3/4] rounded-3xl overflow-hidden shadow-2xl ring-4 ring-white/10 transform transition-transform duration-700 group-hover:-translate-y-2 bg-gradient-to-br from-slate-800/60 to-slate-900/90 backdrop-blur-md p-8">
                <Image 
                  src="https://i.postimg.cc/Vv096dgK/4000-Front-Facing-removebg-preview.webp" 
                  alt="Worcester Bosch 4000 System Boiler" 
                  fill 
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-start">
            ...
            <div className="lg:col-span-4 flex flex-col items-center lg:sticky lg:top-32">
              <div className="relative w-[70%] sm:w-[50%] lg:w-[90%] max-w-[320px] aspect-[4/5] mb-8 group">
                <Image 
                  src="https://i.postimg.cc/s2DMLY9d/EVOKE-7-300x300.webp" 
                  alt="Worcester Bosch 4000 System Hardware Overview" 
                  fill 
            ...
            <div className="lg:col-span-8 flex flex-col">
              ...
              <div className="mb-8 space-y-4 text-slate-600 font-medium text-[0.95rem] lg:text-[1.05rem] leading-[1.7] text-balance">
                ...
                <div className="py-2">
                  <span className="inline-block bg-blue-50 text-blue-800 font-black px-4 py-2 border-l-4 border-blue-600 rounded-r-md">
                    * Up to a 10 Year guarantee when installed by Tom Sutton Heating
                  </span>
                </div>
                <p>
                  Worcester's entire gas boiler range is able to run on a 20% hydrogen blend - so you can be confident it will run on gas for its lifetime.
                </p>
              </div>
              ...
              <div className="bg-white border border-slate-100 rounded-3xl p-6 sm:p-8 shadow-[0_15px_30px_rgba(0,0,0,0.03)] relative overflow-hidden group">
                ...
                <ul className="space-y-1 relative z-10">
                  {[
                    ...
                    "Worcester's quietest system boiler, making it easy to live with",
                    ...
                    "Can be used with Greenskies solar panels for energy and cost-saving"
                  ].map((feature, idx) => (
      ...
      <section className="py-16 sm:py-24 bg-slate-50 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <FaqAccordion items={[
            {
              question: "What is the Worcester Bosch 4000 System boiler?",
              answer: "The Greenstar 4000 System is a high-efficiency system boiler that works with a hot water cylinder to provide central heating and stored hot water. It is ideal for larger homes with multiple bathrooms that require hot water from several outlets at the same time."
            },
            {
              question: "When should I choose a system boiler over a combi?",
              answer: "A system boiler is the better choice if your home has two or more bathrooms, you need to run multiple showers or taps simultaneously, or you have a high hot water demand. The stored hot water in the cylinder ensures consistent pressure and temperature to all outlets."
            },
            {
              question: "What warranty does the 4000 System come with?",
              answer: "As Worcester Bosch Accredited Installers, we can offer up to a 13-year warranty on the Greenstar 4000 System boiler. Our accredited status ensures you get the maximum available warranty at no extra cost."
            },
            {
              question: "Is the 4000 System compatible with renewable energy?",
              answer: "Yes, the Greenstar 4000 System is compatible with the Worcester Bosch Greenskies solar thermal panel system, allowing you to use free solar energy to pre-heat your hot water and further reduce your energy bills."
            }
          ]} />
        </div>
      </section>
