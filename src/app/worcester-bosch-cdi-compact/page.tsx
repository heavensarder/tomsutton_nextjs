...
export default function WorcesterBoschCdiCompactPage() {
  return (
    <main className="min-h-screen bg-slate-50">
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-16">
            ...
            <div className="w-full lg:w-[55%] flex flex-col items-center lg:items-start text-center lg:text-left text-white">
              ...
              <h1 className="text-[1.75rem] sm:text-3xl lg:text-[2.75rem] font-black tracking-tight leading-[1.1] mb-5 drop-shadow-md">
                WORCESTER BOSCH CDI COMPACT INSTALLATION
              </h1>
              ...
              <div className="space-y-2 text-[0.95rem] sm:text-[1.05rem] font-medium leading-[1.6] text-white/90 overflow-hidden mb-10 max-w-[600px]">
                <p>Get a new Worcester Bosch CDi Compact boiler expertly installed by our dedicated local team. We offer fast, friendly and highly reliable service ensuring your home stays comfortably warm throughout the year.</p>
              </div>
            ...
            <div className="w-full lg:w-[40%] relative mt-8 lg:mt-0 group z-20 flex justify-center lg:justify-end">
              <div className="relative w-full max-w-[300px] sm:max-w-[350px] aspect-[3/4] rounded-3xl overflow-hidden shadow-2xl ring-4 ring-white/10 transform transition-transform duration-700 group-hover:-translate-y-2 bg-gradient-to-br from-slate-800/60 to-slate-900/90 backdrop-blur-md p-8">
                <Image 
                  src="https://i.postimg.cc/gkmzKfFF/imageonline-co-whitebackgroundremoved-19-187x300.webp" 
                  alt="Worcester Bosch CDi Compact Boiler" 
                  fill 
      ...
      <section className="py-16 sm:py-24 bg-slate-50 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <FaqAccordion items={[
            {
              question: "What is special about the CDi Compact?",
              answer: "The Greenstar CDi Compact is Worcester Bosch’s most space-efficient boiler, designed to fit inside a standard kitchen cupboard. Despite its compact size, it delivers the same high performance and efficiency as larger models."
            },
            {
              question: "Where can the CDi Compact be installed?",
              answer: "Thanks to its ultra-compact dimensions, the CDi Compact can be installed inside a standard kitchen cupboard, utility room, bedroom, or any enclosed space with adequate ventilation. It offers the most flexible installation options of any Worcester Bosch boiler."
            },
            {
              question: "What warranty does the CDi Compact come with?",
              answer: "As Worcester Bosch Accredited Installers, we offer up to a 13-year warranty on the CDi Compact. Its proven reliability and compact design make it one of the most popular boilers in our installation range."
            },
            {
              question: "Is the CDi Compact suitable for my home?",
              answer: "The CDi Compact is ideal for small to medium-sized homes with limited installation space. If you have one bathroom and are looking for a boiler that delivers powerful performance without taking up much room, the CDi Compact is an excellent choice."
            }
          ]} />
        </div>
      </section>
