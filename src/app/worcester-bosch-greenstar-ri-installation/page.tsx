...
export default function WorcesterBoschGreenstarRiPage() {
  return (
    <main className="min-h-screen bg-slate-50">
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-16">
            ...
            <div className="w-full lg:w-[55%] flex flex-col items-center lg:items-start text-center lg:text-left text-white">
              ...
              <h1 className="text-[1.75rem] sm:text-3xl lg:text-[2.75rem] font-black tracking-tight leading-[1.1] mb-5 drop-shadow-md">
                WORCESTER BOSCH GREENSTAR RI INSTALLATION
              </h1>
              ...
              <div className="space-y-2 text-[0.95rem] sm:text-[1.05rem] font-medium leading-[1.6] text-white/90 overflow-hidden mb-10 max-w-[600px]">
                <p>Get a new Worcester Bosch Greenstar Ri boiler expertly installed by our dedicated local team. We offer fast, friendly and highly reliable service ensuring your home stays comfortably warm throughout the year.</p>
              </div>
            ...
            <div className="w-full lg:w-[40%] relative mt-8 lg:mt-0 group z-20 flex justify-center lg:justify-end">
              <div className="relative w-full max-w-[300px] sm:max-w-[350px] aspect-[3/4] rounded-3xl overflow-hidden shadow-2xl ring-4 ring-white/10 transform transition-transform duration-700 group-hover:-translate-y-2 bg-gradient-to-br from-slate-800/60 to-slate-900/90 backdrop-blur-md p-8">
                <Image 
                  src="https://i.postimg.cc/1zmPGFLr/imageonline-co-whitebackgroundremoved-20-205x300.webp" 
                  alt="Worcester Bosch Greenstar Ri Boiler" 
                  fill 
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-start">
            ...
            <div className="lg:col-span-4 flex flex-col items-center lg:sticky lg:top-32">
              <div className="relative w-[70%] sm:w-[50%] lg:w-[90%] max-w-[320px] aspect-[4/5] mb-8 group">
                <Image 
                  src="https://i.postimg.cc/3R6TQcWP/Ri-1-300x300.webp" 
                  alt="Worcester Bosch Greenstar Ri Hardware Overview" 
                  fill 
            ...
            <div className="lg:col-span-8 flex flex-col">
              ...
              <div className="mb-8 space-y-4 text-slate-600 font-medium text-[0.95rem] lg:text-[1.05rem] leading-[1.7] text-balance">
                <p>
                  The Worcester Bosch Greenstar Ri boiler is a compact, wall-mounted boiler that is perfect for small and medium-sized homes. They also make a version for larger homes. (Not pictured here) It is also perfect for replacing a boiler in an existing system.
                </p>
                <p>
                  Small enough to be installed in a standard kitchen cupboard, the boiler can be used with our range of high-efficiency unvented hot water cylinders or your current hot water cylinder.
                </p>
              </div>
      ...
      <section className="py-16 sm:py-24 bg-slate-50 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <FaqAccordion items={[
            {
              question: "What is the Worcester Bosch Greenstar Ri?",
              answer: "The Greenstar Ri is a regular (heat-only) boiler that works with a traditional heating system including a hot water cylinder and cold water storage tank. It is an ideal replacement for an existing regular boiler without needing to change your entire system."
            },
            {
              question: "When should I choose a regular boiler?",
              answer: "A regular boiler is the best choice if your home already has a traditional heating system with a hot water cylinder and cold water tank, especially if you have good water pressure and want to minimise disruption during installation."
            },
            {
              question: "Can the Greenstar Ri work with solar thermal?",
              answer: "Yes, the Greenstar Ri is fully compatible with solar thermal panels, allowing you to supplement your hot water heating with free solar energy. This can significantly reduce your energy bills and carbon footprint."
            },
            {
              question: "What warranty is available?",
              answer: "As Worcester Bosch Accredited Installers, we offer up to a 13-year warranty on the Greenstar Ri. This ensures long-term protection for your investment in quality heating."
            }
          ]} />
        </div>
      </section>
