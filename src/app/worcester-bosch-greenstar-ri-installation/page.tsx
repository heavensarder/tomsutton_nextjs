        ...
        <div className="container mx-auto px-4 max-w-[1200px]">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            ...
            <div className="flex flex-col gap-8 lg:gap-10">
              ...
              {/* Worcester Bosch Logo Standalone */}
              <div className="relative w-full h-[150px] px-10 py-8 bg-white rounded-[3rem] shadow-[0_15px_40px_rgba(0,0,0,0.06)] border border-slate-100 flex items-center justify-center mt-2 group border-b-[6px] border-b-[#006a44] hover:border-b-blue-600 transition-colors duration-500 overflow-hidden cursor-default">
                 ...
                 <div className="relative w-[320px] h-full opacity-90 group-hover:opacity-100 transition-opacity group-hover:scale-[1.04] duration-500">
                    <Image src="https://i.postimg.cc/DwgXz1kn/worcester_bosch_logo.png" fill className="object-contain" alt="Worcester Bosch Group" unoptimized/>
                 </div>
              </div>
