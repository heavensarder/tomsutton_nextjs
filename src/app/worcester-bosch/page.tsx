        ...
        <div className="container mx-auto px-4 max-w-[1200px]">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
              ...
              <ul className="space-y-5 mb-14">
                {[
                  ...
                  <li key={idx} className="flex items-start gap-4 group">
                    <div className="mt-1 flex-shrink-0 w-6 h-6 rounded-full bg-green-100 flex items-center justify-center border border-green-200 group-hover:bg-[#00a651] transition-colors">
            ...
            <div className="flex flex-col gap-8 lg:gap-10">
              ...
              <div className="relative w-full h-[150px] px-10 py-8 bg-white rounded-[2.5rem] shadow-[0_15px_40px_rgba(0,0,0,0.06)] border border-slate-100 flex items-center justify-center mt-2 group border-b-8 border-b-[#00a651] hover:border-b-blue-600 transition-colors duration-500 overflow-hidden cursor-default">
                 ...
                 <div className="relative w-[320px] h-full opacity-90 group-hover:opacity-100 transition-opacity group-hover:scale-[1.04] duration-500">
                   <Image src="https://i.postimg.cc/28MLVLD2/worcester-bosch-accredited-installer-png.webp" alt="Worcester Bosch Accredited Installer" fill className="object-contain" unoptimized />
                 </div>
              </div>
