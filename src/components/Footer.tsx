        ...
        <footer className="bg-[#191919] text-gray-400 pt-16 pb-6 border-t border-gray-800 font-sans" suppressHydrationWarning>
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-16">
                    ...
                    <div className="flex flex-col space-y-6">
                        ...
                        <div className="space-y-4 text-[15px]">
                            ...
                            <div>
                                ...
                                <a href="mailto:info@tomsuttonheating.co.uk" className="hover:text-white transition-colors">info@tomsuttonheating.co.uk</a>
                            </div>

                            <div>
                                <h4 className="text-white font-semibold mb-1">Office</h4>
                                <p className="leading-relaxed">19 Longleat Gardens, New Milton, Hampshire,<br/>BH25 5UZ</p>
                            </div>
                        </div>

                        {/* Social Icons Array */}
                        <div className="flex items-center gap-3 pt-2">
                            <a href="#" className="w-9 h-9 rounded-full bg-white/10 flex items-center justify-center hover:bg-white/20 transition-colors text-white">
                            ...
                            <a href="mailto:info@tomsuttonheating.co.uk" className="w-9 h-9 rounded-full bg-white/10 flex items-center justify-center hover:bg-white/20 transition-colors text-white">
                            ...
                            <a href="https://www.google.com/maps?cid=8226595044909973442" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-white/10 flex items-center justify-center hover:bg-white/20 transition-colors text-white">
                    ...
                    <div className="flex flex-col space-y-4 md:space-y-6">
                        ...
                        <div className="w-full relative py-2">
                            <Image
                                src="https://i.postimg.cc/nr1K1NHx/Footer-Logos-Updated-1.webp"
                        ...
                        <div className="space-y-1 text-[15px] pt-2 md:pt-4 text-gray-400">
                            <p>OFTEC Company Reg No: C103319</p>
                            <p>Technician Reg No: 38391</p>
                            <p>VAT Number: 263 5356 96</p>
                        </div>
                    </div>
                ...
                <div className="border-t border-gray-800 mt-16 pt-8 flex flex-col md:flex-row items-center justify-between text-sm text-gray-500 gap-4">
                    <p>&copy; {new Date().getFullYear()} Tom Sutton Heating. All Rights Reserved.</p>
                    <p>
