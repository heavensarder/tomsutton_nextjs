                ...
                {isMobileOpen && (
                    <div className="lg:hidden bg-white shadow-2xl border-t-2 border-[#ff5e14] w-full absolute left-0 top-full max-h-[85vh] overflow-y-auto z-50">
                        <div className="flex flex-col select-none">
                            ...
                            <Link href="/contact" onClick={() => setIsMobileOpen(false)} className={`px-6 py-4 text-[15px] font-semibold border-b border-gray-100 transition-colors  ${pathname === '/contact' ? 'text-[#ff5e14] bg-orange-50' : 'text-slate-800 hover:text-[#ff5e14] hover:bg-orange-50'}`}>
                                Contact
                            </Link>
