...
const NavBar = () => {
    ...
    const isInstall = ['/new-boiler', '/our-boiler-brands', '/alpha', '/worcester', '/online-boiler', '/combi-', '/lpg-boilers', '/oil-boilers', '/unvented'].some(p => pathname.includes(p)) || pathname === '/new-gas-boilers-2';
    ...
    const isMore = ['/about', '/blog', '/gas', '/heating', '/oil', '/nest-thermostat', '/book-services'].some(p => pathname.includes(p));
                ...
                <div className="w-full xl:px-24 lg:px-12 md:px-8 px-4">
                    <div className="flex justify-between items-center h-full">
                        ...
                        <div className="hidden lg:flex space-x-2 xl:space-x-4 items-center h-full flex-1 justify-center relative">
                            ...
                            <Link href="/our-reviews" className={`group relative px-2 xl:px-3 py-6 text-[14px] xl:text-[15px] font-semibold  transition-colors whitespace-nowrap ${isReviews ? 'text-orange-500' : 'text-slate-800 hover:text-orange-500'}`}>
                                Reviews
                                <span className={`absolute bottom-[20px] left-1/2 -translate-x-1/2 h-0.5 bg-orange-500 transition-all duration-300 ease-out ${isReviews ? 'w-full' : 'w-0 group-hover:w-full'}`}></span>
                            </Link>
                            ...
                            <div className="group/nav relative h-full flex items-center">
                                ...
                                <div className="absolute left-0 top-[100%] opacity-0 invisible group-hover/nav:opacity-100 group-hover/nav:visible group-hover/nav:translate-y-0 translate-y-2 transition-all duration-300 w-72 bg-white border-t-4 border-orange-500 shadow-2xl z-50 py-2 rounded-b-lg">
                                    ...
                                    <Link href="/new-gas-boilers-2" className="block px-6 py-3.5 text-sm font-semibold text-gray-700 hover:text-orange-500 hover:bg-orange-50 transition-colors">New Gas Boilers</Link>
                            ...
                            <div className="group/nav relative h-full flex items-center">
                                ...
                                <div className="absolute right-0 top-full opacity-0 invisible group-hover/nav:opacity-100 group-hover/nav:visible group-hover/nav:translate-y-0 translate-y-2 transition-all duration-300 w-72 bg-white border-t-4 border-orange-500 shadow-2xl z-50 py-2 rounded-b-lg">
                                    <Link href="/book-services-online" className="block px-6 py-3.5 text-sm font-semibold text-gray-700 hover:text-orange-500 hover:bg-orange-50 transition-colors">Book Services Online</Link>
                ...
                {isMobileOpen && (
                    <div className="lg:hidden bg-white shadow-2xl border-t-2 border-[#ff5e14] w-full absolute left-0 top-full max-h-[85vh] overflow-y-auto z-50">
                        <div className="flex flex-col select-none">
                            ...
                            <Link href="/our-reviews" onClick={() => setIsMobileOpen(false)} className="px-6 py-4 text-[15px] font-semibold text-slate-800 border-b border-gray-100 hover:text-[#ff5e14] hover:bg-orange-50 transition-colors ">
                                Reviews
                                </Link>
                            ...
                            <div className="border-b border-gray-100">
                                ...
                                <div className={`overflow-hidden transition-all duration-300 ease-in-out ${openMobileDropdown === 'more' ? 'max-h-[600px] opacity-100' : 'max-h-0 opacity-0'}`}>
                                    <div className="bg-slate-50 px-6 py-2 pb-4 shadow-inner">
                                        <div className="border-l-2 border-orange-200 ml-2 pl-4 space-y-1">
                                            <Link href="/book-services-online" onClick={() => setIsMobileOpen(false)} className="block py-2.5 text-[14px] font-semibold text-slate-600 border-b border-gray-200/50 hover:text-[#ff5e14]">Book Services Online</Link>
