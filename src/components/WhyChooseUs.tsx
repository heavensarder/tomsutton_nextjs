        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 items-center">
          ...
          <ScrollAnimate animation="fadeRight" delay={200} className="flex-1 pt-8 lg:pt-0">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 mb-8">
              {(data.features || []).map((featureItem: any, i: number) => {
                const textValue = typeof featureItem === 'object' ? (featureItem.title || featureItem.description || featureItem.text || '') : featureItem;
